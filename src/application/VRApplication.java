...
import datatypes.PersonalData;
import datatypes.TrunkSizeData;
...
//	To Do: Make the function storeOffer correctly
	
//	public void storeOffer(String travelDate, String departureTime, String startPlace, String destinationPlace,
//			TrunkSizeData trunkSize, String numberOfSeats, String price, PersonalData contactInformation) {
//	
//		// Parse inputs to correct datatypes
//		try {
//			DateFormat dateFormat = new SimpleDateFormat("MM/dd/yyyy");
...
//			long time = date.getTime();
//			Timestamp startTimeSQL = new Timestamp(time);
//			date = dateFormat.parse(departureTime);
//			time = date.getTime();
//			Timestamp endTimeSQL = new Timestamp(time);
//			int capacitySQL = Integer.parseInt(capacity);
//			double feeSQL = Double.parseDouble(fee);
